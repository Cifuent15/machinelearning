...
Here I have a basic neural networks algorithms and randomforest models. some of the archive are using the same dataset but with a different approach.
...
It is giving you the number of trees and the depth of the tree that give you the best outcome or best score to make predictions.

what does that mean the output of the algorithms that use Neural Network algorithms?
It is giving you the prediction's score within the test data.
